...
func (ms *MemoryServer) handleHealth(ctx context.Context, params map[string]interface{}) (interface{}, error) {
...
func (ms *MemoryServer) GetServer() *mcp.Server {
	return ms.mcpServer
}
