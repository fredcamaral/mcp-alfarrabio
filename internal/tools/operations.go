...
const (
	...
	// Additional operations for threads and relations (not in core operations yet)
	OpCreateThread   StoreOperations = "create_thread"
	OpCreateRelation StoreOperations = "create_relation"
)
...
const (
	...
	// OpDetectPatterns is an alias for OpDetectContentPatterns for handler compatibility
	OpDetectPatterns = OpDetectContentPatterns
	...
	OpSuggestRelated   = OpRecommendRelatedContent
	OpAnalyzeQuality   = OpAnalyzeContentQuality
	OpDetectConflicts  = OpDetectContentConflicts
	OpGenerateInsights = OpGenerateContentInsights
	OpPredictTrends    = OpPredictContentTrends
)
...
const (
	...
	// Aliases for handler compatibility
	OpHealth            = OpCheckSystemHealth
	OpExportProject     = OpExportProjectData
	OpImportProject     = OpImportProjectData
	OpGenerateCitation  = OpGenerateContentCitation
	OpValidateIntegrity = OpValidateDataIntegrity
	OpGetMetrics        = OpCalculateSystemMetrics
)
